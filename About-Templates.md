...
// The Concatenations parameter is a way to tell OMRChecker which fields need to be joined together before outputting into the csv.
  "concatenations": {
  ...
  // a QBlock is either a rectangular box, or a grid of such boxes.
  "qBlocks": {
    // name of the QBlock
    "Medium": {
